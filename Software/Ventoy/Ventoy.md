...
# Much faster
cd ~/opt/ventoy && sudo ./CreatePersistentImg.sh -s 4096 -t ext4 -l 'casper-rw' -o /tmp/persistence-4096.dat
cp /tmp/persistence-4096.dat /media/cyb10101/Ventoy/persistence/ubuntu-20.04.4-desktop.dat && sync
